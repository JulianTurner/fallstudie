...
\subsubsection{Gesetzliche Regelungen}
Deutschland könnte ein Vorreiter für autonomen Fahren werden, und das daraus resultierende mögliche Potential schnell in den Straßenverkehr bringen.

Am 21. Juni 2017 würde ein Gesetzt erlassen welches autonomes Fahren in gewissen Situationen ermöglicht.
...
Ferner it es nun möglich gewisse Funktionen nachträglich Freizuschalten oder zu deaktivieren.
...
eine Plan für die Forschung am autonomen Fahren beschlossen.

Dieser Plan soll sich an vielen Punkten orientieren wie unter anderem Sicherheit, Effizienz, Nachhaltigkeit, Barrierefreiheit, Bezahlbarkeit.
